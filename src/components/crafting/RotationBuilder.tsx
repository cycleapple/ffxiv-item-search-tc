...
const ACTION_NAMES_SHORT: Record<CraftingAction, string> = {
  ...
  [CraftingAction.CarefulObservation]: '設變',
  [CraftingAction.HeartAndSoul]: '專心',
  [CraftingAction.RefinedTouch]: '精煉',
  [CraftingAction.DaringTouch]: '冒進',
  [CraftingAction.ImmaculateMend]: '苦行',
  [CraftingAction.QuickInnovation]: '快革',
  [CraftingAction.TrainedPerfection]: '巧奪',
